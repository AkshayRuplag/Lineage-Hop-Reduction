...
,'PKG_GRP_FULLLOAD_OFFSETS.PRC_FULLLOAD_FCT_CLAIMPMNT_DET_OFFSET3_R' V_CREATED_BY_R--12-DEC-2023 CHANGES
,'PKG_GRP_FULLLOAD_OFFSETS.PRC_FULLLOAD_FCT_CLAIMPMNT_DET_OFFSET3_R' V_LAST_MODIFIED_BY_R--12-DEC-2023 CHANGES
,FIC_MIS_DATE_R
,N_SEQ_R
,D_PAYPERIOD_START_R
,D_PAYPERIOD_END_R
...
,N_VERSION_NUMBER_R
,T_EVENT_TIMESTAMP_R
,'OFFSET3' V_OFFSET_TYPE_R--12-DEC-2023 CHANGES
,N_WORKSHEET_SEQ_NBR_OBJECTNM_R--12-DEC-2023 CHANGES
,N_SOURCE_SYSTEM_KEY_R--12-DEC-2023 CHANGES
,V_LINK_OBJECTNUM_R--12-DEC-2023 CHANGES
FROM
...
V_PAY_STATUS_R ,N_ADJ_NET_BENEFIT_R, N_GROSS_BENEFIT_R, N_PRIMARY_PAYEE_R,V_CHECK_NUM_R, D_TRANS_DATE_R, N_ADJ_GROSS_BENEFIT_R,V_LINK_OBJECTNUM_R---12-DEC-2023
FROM FCT_BENEFIT_PAYMENT_R
WHERE (UPPER(V_REFERENCE_R) like 'MINIMUM BENEFIT APPLIED%'  AND V_PAY_DESCR_R = 'ALLSOURCE')
...
fws.N_WORKSHEET_SEQ_NBR_OBJECTNM_R,--12-DEC-2023
FWS.N_SOURCE_SYSTEM_KEY_R,--12-DEC-2023
FBP_2.V_LINK_OBJECTNUM_R,---12-DEC-2023
...
,amt_2.N_WORKSHEET_SEQ_NBR_OBJECTNM_R,--12-DEC-2023
AMT_2.N_SOURCE_SYSTEM_KEY_R--12-DEC-2023
,amt_2.V_LINK_OBJECTNUM_R--12-DEC-2023
