  ...
  CREATE MATERIALIZED VIEW "ATOMIC"."FCT_CLAIM_NOTE_R_DUR_MV_SSL" ("N_CLAIM_SK_R", "D_CREATED_DATE_R", "V_NOTE_CONTENT_R", "DUPREMOV", "V_MED_NOTE_DATA_R")
 ...
 NOCOMPRESS LOGGING
  ...
  AS SELECT /*+PARALLEL(4)*/ NOTE1.N_CLAIM_SK_R ,
   ...
   -- cast(NOTE1.V_NOTE_DATA_R as varchar(4000)) as V_MED_NOTE_DATA_R--13-mar-2024 changes COMMENTED
   TO_CHAR(DBMS_LOB.SUBSTR(NOTE1.v_note_data_r,2000,1)) V_MED_NOTE_DATA_R --13-mar-2024 changes added
