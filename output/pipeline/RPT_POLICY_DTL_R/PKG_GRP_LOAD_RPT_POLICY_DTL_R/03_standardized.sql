...
TYPE var_upd_tbl_client_type IS TABLE OF cur_upd_client_dtls%ROWTYPE INDEX BY PLS_INTEGER;
...
IS
  ...
  TYPE var_upd_tbl_uw_type IS TABLE OF cur_upd_uw_dtls%ROWTYPE INDEX BY PLS_INTEGER;
...
--start time
  ...
  TYPE var_upd_tbl_theft_ind_type IS TABLE OF cur_upd_theft_ind_col%ROWTYPE INDEX BY PLS_INTEGER;
  lt_var_upd_tbl_theft_ind_typ_rec var_upd_tbl_theft_ind_type;
   ...
   AND t4804933.N_PLAN_DESIGN_SRC_VERSION_NO_R = (
    ...
    TYPE var_upd_tbl_theft_dt_type IS TABLE OF cur_upd_theft_dt_col%ROWTYPE INDEX BY PLS_INTEGER;
...
--Cursor to fetch Prs Strs Indicator
   ...
   AND t4804933.N_PLAN_DESIGN_SRC_VERSION_NO_R = (
	...
	TYPE var_upd_prs_strs_ind IS TABLE OF cur_upd_prs_strs_ind_r%ROWTYPE INDEX BY PLS_INTEGER;
  ...
  TYPE var_upd_tbl_elimperiod_type IS TABLE OF cur_upd_elimperiod_col%ROWTYPE INDEX BY PLS_INTEGER;
...
--Cursor to fetch Eap Description
  ...
  GROUP BY t4804933.n_policy_sk_r,t4804933.V_COVERAGE_CODE_R;
   ...
   TYPE var_upd_tbl_eap_desc_type IS TABLE OF cur_upd_eap_desc_col%ROWTYPE INDEX BY PLS_INTEGER;
  ...
  GROUP BY t4804933.n_policy_sk_r,t4804933.V_COVERAGE_CODE_R;
	  ...
	  TYPE var_upd_tbl_bereave_desc_type IS TABLE OF cur_upd_bereave_desc_col%ROWTYPE INDEX BY PLS_INTEGER;
   ...
   AND t4804933.N_PLAN_DESIGN_SRC_VERSION_NO_R = (
	 ...
	 GROUP BY t4804933.n_policy_sk_r;
	  ...
	  TYPE var_upd_tbl_eap_eff_date_type IS TABLE OF cur_upd_eap_eff_date_col%ROWTYPE INDEX BY PLS_INTEGER;
	...
	IS
	SELECT t4804933.n_policy_sk_r, MAX(t4805277.v_override_description_r) AS V_BEREAVEDATE_R
	  FROM fct_plan_design_summary_r t4805277
		 , DIM_PLAN_DESIGN_DIRECTORY_R t4804933  -- M-0031: GTT eliminated
	 WHERE t4804933.n_plan_design_sk_r = t4805277.n_plan_design_sk_r
  ...
  GROUP BY t4804933.n_policy_sk_r;
	  ...
	  TYPE var_upd_tbl_bereavedate_type IS TABLE OF cur_upd_bereavedate_col%ROWTYPE INDEX BY PLS_INTEGER;
  ...
  TYPE var_upd_tbl_cross_sell_type IS TABLE OF cur_upd_cross_sell_col%ROWTYPE INDEX BY PLS_INTEGER;
  ...
  CURSOR cur_upd_nxtrenewaldt_col
    ...
    TYPE var_upd_tbl_nxtrenewaldt_type IS TABLE OF cur_upd_nxtrenewaldt_col%ROWTYPE INDEX BY PLS_INTEGER;
	...
	SELECT d_rate_guar_r,n_policy_sk_r
	 ...
	 GROUP BY d_rate_guar_r,n_policy_sk_r;
	  TYPE var_upd_tbl_d_rate_guar_r_type IS TABLE OF cur_upd_d_rate_guar_r_col%ROWTYPE INDEX BY PLS_INTEGER;
   ...
   WHERE n_yearmonth_r = gn_current_month;
    ...
    TYPE var_upd_tbl_option_type IS TABLE OF cur_upd_option_col%ROWTYPE INDEX BY PLS_INTEGER;
    lt_var_upd_tbl_option_typ_rec var_upd_tbl_option_type;

	CURSOR cur_upd_agencycode_cols
	IS
	  select LISTAGG(agent.V_AGENCY_CODE_R, '; ') WITHIN GROUP (ORDER BY agent.n_policy_sk_r,agent.n_reportmonth_r) AS v_agency_code_r,n_policy_sk_r,n_reportmonth_r
	...
	IS
	SELECT MAX(D_BUSINESS_EFF_START_DATE_R) AS D_SUBMISSION_DATE_R ,N_POLICY_SK_R
	...
	TYPE var_upd_tbl_submissiondt_typ IS TABLE OF cur_upd_submission_dt%ROWTYPE INDEX BY PLS_INTEGER;
	...
	TYPE var_upd_tbl_nxtrenewaleffdt_type IS TABLE OF cur_upd_nxtrenewaleffdt_col%ROWTYPE INDEX BY PLS_INTEGER;
...
BEGIN
   ...
   /* OPEN p_out_cursor FOR */
	...
	-- End : Kill/Fill Changes 5th May 2026: Added following
	 ...
	 , dim_grp_policy_dir_r.v_policy_suffix_r AS v_line_of_business_r
