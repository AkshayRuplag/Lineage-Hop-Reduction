create or replace package body pkg_grp_load_rpt_claim_dtl_r
as
/***********************************************************************
...
IS
SELECT  D_ANY_OCC_START_DATE_R--pkg_grp_load_rpt_claim_dtl_r.get_pacs_as_of_date_r D_CLAIM_AS_OF_DATE_R,
...
,PKG_GRP_LOAD_RPT_CLAIM_DTL_R.GET_N_CURR_BENEFIT_PERIOD_DAYS_R(V_CLAIM_NUMBER_R,NULL ) N_CURR_BENEFIT_PERIOD_DAYS_R
,PKG_GRP_LOAD_RPT_CLAIM_DTL_R.GET_N_total_BENEFIT_PERIOD_DAYS_R(V_CLAIM_NUMBER_R,NULL ) N_totAL_BENEFIT_PERIOD_DAYS_R
FROM rpt_claim_dtl_r
WHERE N_YEARMONTH_R=gn_current_month
...
BEGIN
	...
	gd_pacs_as_of_date_r:=pkg_grp_load_rpt_claim_dtl_r.get_pacs_as_of_date_r;             --19-jan-2024 changes
    GC_TRCMSG:=GC_TRCMSG||'gd_pacs_as_of_date_r       :->'||gd_pacs_as_of_date_r||CHR(13);--19-jan-2024 changes
    --GC_TRCMSG:=GC_TRCMSG||'2.Refresh MVs starts  '||CHR(13);
    --pkg_grp_load_rpt_claim_dtl_r.prc_refresh_ssl_mvs;
    ...
    pkg_grp_load_rpt_claim_dtl_r.prc_upd_del_data;
    ...
    pkg_grp_load_rpt_claim_dtl_r.prc_get_cur_data (var_ref_cur);
    ...
    pkg_grp_load_rpt_claim_dtl_r.prc_insert_dummy_rec;
    ...
    pkg_grp_load_rpt_claim_dtl_r.prc_rebuild_indexes;
    ...
    UPDATE /*+PARALLEL(4)*/ RPT_CLAIM_DTL_R
      set D_CLAIM_AS_OF_DATE_R=gd_pacs_as_of_date_r--pkg_grp_load_rpt_claim_dtl_r.get_pacs_as_of_date_r
    where RPT_CLAIM_DTL_R.n_yearmonth_r=gn_current_month;
	commit;
	...
	--   SELECT pkg_grp_load_rpt_claim_dtl_r.get_v_claim_ach_payment_ind_r(lt_var_upd_tbl_pmntind_typ(I).N_CLAIM_SK_R)
...
n_curr_benefit_period_days_r
INTO ln_curr_amnt
FROM RPT_CLAIM_DTL_R_CURBENPERDYS_MV_SSL
WHERE V_CLAIM_NUMBER_R=p_v_claim_number_r
  AND n_curr_benefit_period_days_r IS NOT NULL;--31/10/24 changes
...
IS
SELECT * FROM rpt_claim_dtl_r_claimdec_GTT;
...
end PKG_GRP_LOAD_RPT_CLAIM_DTL_R;